...
| **ax-lecture-site** | AX 참여형 강의 후보 8종 제안 사이트. 1인 3표 투표로 상위 3개만 실제로 엽니다. 주제 도출 근거는 `docs/`. |
| **capability-cards** | 팀·개인 역량 진단 카드뉴스 · 원페이지 · 레이더 세트. 링크드인 배너 시안 포함. |
| **cosmic-journey** | 수학으로 걷는 우주 항해 — 속도를 주 계기로 두고 천체 크기를 압축 공간에 보존하는 인터랙티브. |
